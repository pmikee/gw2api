...
public class ColorSheet {
	...
	public static void main(String[] args) throws RemoteException, FileNotFoundException, UnsupportedEncodingException {
		...
		sb.append("<tr><th>Name</th><th>Default</th><th>Cloth</th><th>Leather</th><th>Metal</th></th>\n");
		
		for (Entry<Long, Color> entry : colors.entrySet()) {
			
			sb.append("<tr><td>");
			sb.append(entry.getValue().getName());
			sb.append("</td><td style=\"background-color: ").append( ColorConversion.getRgbColor(entry.getValue().getDefaultColor())).append(";\">");
			sb.append("&nbsp;");
			sb.append("</td><td style=\"background-color: ").append( ColorConversion.getRgbColor(entry.getValue().getClothColor())).append(";\">");
			sb.append("&nbsp;");
			sb.append("</td><td style=\"background-color: ").append( ColorConversion.getRgbColor(entry.getValue().getLeatherColor())).append(";\">");
			sb.append("&nbsp;");
			sb.append("</td><td style=\"background-color: ").append( ColorConversion.getRgbColor(entry.getValue().getMetalColor())).append(";\">");
			sb.append("&nbsp;");
			sb.append("</tr>\n");
